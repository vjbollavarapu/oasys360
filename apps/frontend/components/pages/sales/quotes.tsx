          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">50.6% acceptance rate</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Acme Corp - $45,000 - Accepted</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">TechStart Inc - $32,500 - Pending</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-medium">Quote #Q-2024-003</p>
                      <p className="text-sm text-muted-foreground">Global Solutions - $67,800 - Draft</p>
                    </div>
                  </div>
                  <div className="text-right">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="text-center text-muted-foreground">
                  ...
                  <p>Quote list will appear here</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="templates" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage quote templates and designs
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center text-muted-foreground">
