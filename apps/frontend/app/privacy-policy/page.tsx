            ...
            <Card className="sticky top-4 bg-white shadow-lg border-gray-200">
              ...
              <CardContent className="bg-white">
                <nav className="space-y-2">
                  <a href="#overview" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    1. Overview
                  </a>
                  <a href="#information-we-collect" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    2. Information We Collect
                  </a>
                  <a href="#how-we-use-information" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    3. How We Use Information
                  </a>
                  <a href="#information-sharing" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                  ...
                  <a href="#your-rights" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    6. Your Rights
                  </a>
                  <a href="#cookies" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    7. Cookies & Tracking
                  </a>
                  <a href="#international-transfers" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    8. International Transfers
                  </a>
                  <a href="#contact" className="block text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-all">
                    9. Contact Us
                  </a>
                </nav>
              </CardContent>
