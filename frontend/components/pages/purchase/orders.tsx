                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Office Supplies - $1,234.56</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">IT Equipment - $5,678.90</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Marketing Materials - $2,345.67</p>
                    </div>
                  </div>
                  <div className="text-right">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center text-muted-foreground">
                ...
                <p>Purchase orders interface will appear here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="requisitions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage purchase requisitions and requests
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center text-muted-foreground">
