            ...
            <Card className="sticky top-4">
              ...
              <CardContent>
                <nav className="space-y-2">
                  <a href="#acceptance" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    1. Acceptance of Terms
                  </a>
                  <a href="#description" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    2. Service Description
                  </a>
                  <a href="#user-accounts" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    3. User Accounts
                  </a>
                  <a href="#acceptable-use" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    4. Acceptable Use
                  </a>
                  <a href="#payment-terms" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    5. Payment Terms
                  </a>
                  <a href="#intellectual-property" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    6. Intellectual Property
                  </a>
                  <a href="#data-security" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    7. Data & Security
                  </a>
                  <a href="#limitation-liability" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    8. Limitation of Liability
                  </a>
                  <a href="#termination" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    9. Termination
                  </a>
                  <a href="#governing-law" className="block text-sm text-gray-600 hover:text-blue-600 transition-colors">
                    10. Governing Law
                  </a>
                </nav>
              </CardContent>
